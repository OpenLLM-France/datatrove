...
class JZSlurmPipelineExecutor(PipelineExecutor):
    ...
    def __init__(
        ...
        depends: JZSlurmPipelineExecutor | None = None,
    ...
    def launch_job(self):
        ...
        assert not self.depends or (
            isinstance(self.depends, JZSlurmPipelineExecutor)
        ), "depends= must be a JZSlurmPipelineExecutor"
        if self.depends:
